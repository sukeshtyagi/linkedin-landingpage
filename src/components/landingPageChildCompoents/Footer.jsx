...
function Footer() {
  return (
    <div className="Outer box-border w-3/4 md:w-full h-fit mx-auto mt-4 mb-16">
      <div className="footer  box-border flex flex-col md:flex-row justify-center items-center md:gap-6 p-2 bg-red-200 ">
