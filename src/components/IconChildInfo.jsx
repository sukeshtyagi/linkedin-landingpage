  ...
  return (
    <div className="outer box-border h-fit flex justify-center items-start bg-gradient-to-r from-customGray  via-red-100 to-customGray mb-5">
      <div className="inner box-border w-2/5">
        <div className="iconDiv box-border w-full p-2 flex items-center gap-2 mb-4">
          ...
          <h1 className="name text-xl text-yellow-700  w-fit p-2">{name}</h1>
        </div>
        <h1 className="heading text-3xl text-black p-2 font-light">
          {heading}
        </h1>
        ...
        <p className="commonPara text-lg text-gray-500 p-2">
          *Free eligibility determined on log-in.
        </p>
      </div>
      <div className="imgDiv box-border w-1/2 h-fit">
        {name === "On-Demand Learning" && (
          <img
            src="/images/skills.jpg"
            alt=""
            className="h-full mt-16 rounded-xl p-2"
          />
        )}
        ...
        {name === "Monthly Inmail" && (
          <img
            ...
            alt=""
            className="h-96 w-full mt-16 rounded-xl p-2"
          />
        )}
        ...
        {name === "Applicant Insights" && (
          <img
            src="/images/job.png"
            alt=""
            className="h-full w-full mt-16 rounded-xl p-2"
          />
        )}
      </div>
    </div>
